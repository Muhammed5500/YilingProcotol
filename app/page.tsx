    ...
    >
      <div className="mx-auto max-w-6xl px-6 flex items-center justify-between h-[72px]">
        ...
        <div className={`hidden md:flex items-center gap-8 text-[14px] font-medium transition-colors duration-500 ${dark ? "text-[#a3a3a3]" : "text-text-secondary"}`}>
          ...
          <a href="https://yilingmarket-onbase.vercel.app/markets" target="_blank" rel="noopener noreferrer" className={`transition-colors duration-200 ${dark ? "hover:text-white" : "hover:text-text"}`}>Markets</a>
        ...
        <a
          href="https://yilingmarket-onbase.vercel.app/markets"
          target="_blank"
